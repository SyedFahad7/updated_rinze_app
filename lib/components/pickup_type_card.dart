...
class PickupTypeCard extends StatefulWidget {
  const PickupTypeCard({
    super.key,
  ...
  @override
  State<PickupTypeCard> createState() => _PickupTypeCardState();
}

class _PickupTypeCardState extends State<PickupTypeCard> {
  @override
