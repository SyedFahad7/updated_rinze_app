...
import 'package:rinze/components/tabs/orders_tabs/active/active_order_details_tab.dart';
import 'package:rinze/utils/string_utils.dart';
import 'package:http/http.dart' as http;
import 'package:socket_io_client/socket_io_client.dart' as IO;
import '../components/tabs/orders_tabs/active/active_order_tracking_tab.dart';
...
class _ActiveOrderDetailsScreenState extends State<ActiveOrderDetailsScreen>
  ...
  late List<dynamic> serviceTitles;
  ...
  String _getDisplayText() {
    ...
    // Iterate and print each service's title
    ordersList.forEach((service) =>
        print("Service Title: ${service['service']['serviceTitle']}"));
    serviceTitles = ordersList
        .map((service) => service['service']['serviceTitle'])
        .toList();
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: AppColors.retroLime.withOpacity(0.3),
